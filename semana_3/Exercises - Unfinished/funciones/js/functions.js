...
if (isNaN(dni) || dni < 0) { //si dni no es un número o es menor que 0 ==>
	return 'Invalid parameter';
}
	var lockup = 'TRWAGMYFPDXBNJZSQVHLCKE';
	var result = lockup.charAt(dni%23) ; //se divide el número de DNI entre 23,
										//con el operador módulo(%) para saber el resto.
...
array_lengths.push( findLongestWord( ["Red", "Blue", "Grjjjjjjeen", "Joanie", "Greg", "Marcia", "Bobby","Blanka", "Zangief", "Chun Li", "Guile"] )) ;

array_lengths.push( findLongestWord( ["Monkey D. Luffy", "Roronoa Zoro", "Nami", "Usopp", "Tony Tony Chopper",
									 "Sanji", "Nico Robin", "Cyborg Franky", "Brook"]));

array_lengths.push( findLongestWord( ["Dracule Mihawk", "Jinbe", "Crocodile", "Donquixote Doflamingo", "Bartholomew Kuma",
 									  "Marshall D. Teach", "Gekko Moriah", "Boa Hancock", "Trafalgar Law", "Buggy the Clown"]));
...
beautifyLetters([1,5,7,'a','J','p','E']);
*/

/*
var h ={}; <-- hash
h['prueba'] = "Un saludo";  key:value <-> prueba:unsaludo

console.log(h['prueba']);
*/